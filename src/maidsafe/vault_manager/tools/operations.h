...
#ifndef MAIDSAFE_VAULT_MANAGER_TOOLS_KEY_HELPER_OPERATIONS_H_
#define MAIDSAFE_VAULT_MANAGER_TOOLS_KEY_HELPER_OPERATIONS_H_
...
#endif  // MAIDSAFE_VAULT_MANAGER_TOOLS_KEY_HELPER_OPERATIONS_H_
