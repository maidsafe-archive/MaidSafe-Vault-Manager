...
#include "maidsafe/vault_manager/tools/commander.h"

int main(int argc, char* argv[]) {
  maidsafe::log::Logging::Instance().Initialise(argc, argv);

  TLOG(kDefaultColour) << maidsafe::vault_manager::tools::kHelperVersion << '\n';

  try {
    maidsafe::vault_manager::tools::Commander commander(12);
