...
#ifndef MAIDSAFE_VAULT_MANAGER_TOOLS_COMMANDS_CHOOSE_TEST_H_
#define MAIDSAFE_VAULT_MANAGER_TOOLS_COMMANDS_CHOOSE_TEST_H_
...
#endif  // MAIDSAFE_VAULT_MANAGER_TOOLS_COMMANDS_CHOOSE_TEST_H_
