...
#ifndef MAIDSAFE_VAULT_MANAGER_TOOLS_COMMANDER_H_
#define MAIDSAFE_VAULT_MANAGER_TOOLS_COMMANDER_H_
...
#include "maidsafe/vault_manager/tools/operations.h"
...
const std::string kHelperVersion = "MaidSafe Local Network Controller " + kApplicationVersion();
...
#endif  // MAIDSAFE_VAULT_MANAGER_TOOLS_COMMANDER_H_
