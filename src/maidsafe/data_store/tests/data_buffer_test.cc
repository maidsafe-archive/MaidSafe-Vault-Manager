...
class DataBufferTest : public testing::Test {
 protected:
  ...
  public:
//   void data_buffer_(maidsafe::TaggedValue< uint64_t > TaggedValue, maidsafe::TaggedValue< uint64_t > TaggedValue, const DataBuffer::PopFunctor pop_functor, fs::path data_buffer_path_);
};
